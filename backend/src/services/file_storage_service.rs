...
impl FileStorageService {
    ...
    pub async fn upload_to_cloud(
        ...
        let url = match config.storage_type {
            ...
            StorageType::OSS => {
                format!("https://{}.{}/{}", 
                    config.bucket_name, 
                    config.endpoint.unwrap_or_else(|| "oss-cn-hangzhou.aliyuncs.com".to_string()),
                    file_path)
            }
        };
    ...
    pub async fn delete_from_cloud(
        ...
        s3_client
            ...
            .send()
            .await
            .map_err(|e| AppError::InternalServerError(format!("Failed to delete from S3: {}", e)))?;
    ...
    pub async fn batch_delete_from_cloud(
        ...
        let delete = Delete::builder()
            ...
            .build()
            .map_err(|e| AppError::InternalServerError(format!("Failed to build delete request: {}", e)))?;
        ...
        s3_client
            ...
            .send()
            .await
            .map_err(|e| AppError::InternalServerError(format!("Failed to batch delete from S3: {}", e)))?;
    ...
    pub async fn generate_presigned_upload_url(
        ...
        let presigned_request = s3_client
            ...
            .presigned(
                ...
                ).map_err(|e| AppError::InternalServerError(format!("Failed to create presigning config: {}", e)))?
            )
            .await
