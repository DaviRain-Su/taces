...
use crate::{
    ...
    models::{prescription::*, doctor::Doctor},
};
...
pub async fn list_prescriptions(
    ...
    if let Some(search_term) = &search {
        query.push_str(&format!(" AND (code LIKE '%{}%' OR patient_name LIKE '%{}%' OR diagnosis LIKE '%{}%')", 
...
pub async fn create_prescription(pool: &DbPool, dto: CreatePrescriptionDto) -> Result<Prescription> {
